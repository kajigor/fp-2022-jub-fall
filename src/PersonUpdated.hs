...
validatePerson person | null (firstName person) || null (lastName person) || age person < 0 || null (fst (birthCertificate person))
                      || idNumber person /= (0000, 000000) && age person < 14 = False
                      | otherwise = True
