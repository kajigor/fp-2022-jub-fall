...
sumAndMultElems :: (Int, Int) -> (Int, Int) -> (Int, Int)
sumAndMultElems (a1, b1) (a2, b2) = (a1 + a2, b1 * b2)
...
sumAndMult (AtLeastOne x xs) = sumAndMultElems (x, x) (sumAndMult xs)
...
append (AtLeastOne x1 xs1) xs2 = AtLeastOne x1 (append xs1 xs2)
append Empty xs = xs
