...
-- C точки зрения доступных операций (проверки вхождения точки в фигуру, вычисления периметра, сдвигов) 
-- Overlay shape (пустой круг) не будет менять результат этих операций над shape
-- Поэтому в качестве mempty можно поставить пустой круг
instance Monoid Shape where
  mempty = Circle (PointD 0.0 0.0) 0.0
