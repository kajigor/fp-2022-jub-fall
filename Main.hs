...
slideShape (Circle (PointD x y) radius) (PointD delta_x delta_y) =
  Circle (PointD (x + delta_x) (y + delta_y)) radius
slideShape (Rectangle (PointD x0 y0) (PointD x1 y1)) (PointD delta_x delta_y) =
  Rectangle
    (PointD (x0 + delta_x) (y0 + delta_y))
    (PointD (x1 + delta_x) (y1 + delta_y))

-- Проверяет, находится ли точка внутри данной фигуры
isPointInShape :: Shape -> PointT -> Bool
isPointInShape (Circle (PointD center_x center_y) radius) (PointD x y) =
  sqrt ((center_x - x) ^ 2 + (center_y - y) ^ 2) < radius
isPointInShape rectangle (PointD x y) = do
  let Rectangle (PointD normalized_x0 normalized_y0) (PointD normalized_x1 normalized_y1) =
        normalizeRectangle rectangle
  normalized_x0 < x &&
    x < normalized_x1 && normalized_y0 < y && y < normalized_y1
...
testNormalizeRectangle =
  and
    ...
    , normalizeRectangle r1 `shouldBeShape`
      Rectangle (PointD 0 0) (PointD 0.1 0.2)
    , normalizeRectangle r2 `shouldBeShape`
      Rectangle (PointD (-1) 0) (PointD 0 1)
    , normalizeRectangle r3 `shouldBeShape`
      Rectangle (PointD (-777) (-42)) (PointD 13 0)
    , normalizeRectangle sq1 `shouldBeShape` Rectangle (PointD 0 0) (PointD 2 2)
    , normalizeRectangle sq2 `shouldBeShape`
      Rectangle (PointD (-2) 0) (PointD 2 4)
    , normalizeRectangle sq3 `shouldBeShape`
      Rectangle (PointD (-2) (-2)) (PointD 2 2)
    ]
...
testSlideShape =
  and
    ...
    , slideShape r3 p1 `shouldBeShape`
      Rectangle (PointD 13 (-42)) (PointD (-777) 0)
    ...
    , slideShape sq3 p1 `shouldBeShape`
      Rectangle (PointD (-2) (-2)) (PointD 2 2)
    ...
    , slideShape r3 p2 `shouldBeShape`
      Rectangle (PointD 14 (-42)) (PointD (-776) 0)
    ...
    , slideShape sq3 p2 `shouldBeShape`
      Rectangle (PointD (-1) (-2)) (PointD 3 2)
    ...
    , slideShape r3 p3 `shouldBeShape`
      Rectangle (PointD 13 (-41)) (PointD (-777) 1)
    ...
    , slideShape sq3 p3 `shouldBeShape`
      Rectangle (PointD (-2) (-1)) (PointD 2 3)
    ...
    , slideShape r1 p4 `shouldBeShape`
      Rectangle (PointD (-1) 1) (PointD (-0.9) 1.2)
    , slideShape r2 p4 `shouldBeShape` Rectangle (PointD (-2) 1) (PointD (-1) 2)
    , slideShape r3 p4 `shouldBeShape`
      Rectangle (PointD 12 (-41)) (PointD (-778) 1)
    ...
    , slideShape sq3 p4 `shouldBeShape`
      Rectangle (PointD (-3) (-1)) (PointD 1 3)
    ...
    , slideShape r1 p5 `shouldBeShape`
      Rectangle (PointD 1 (-1)) (PointD 1.1 (-0.8))
    , slideShape r2 p5 `shouldBeShape` Rectangle (PointD 0 (-1)) (PointD 1 0)
    , slideShape r3 p5 `shouldBeShape`
      Rectangle (PointD 14 (-43)) (PointD (-776) (-1))
    , slideShape sq1 p5 `shouldBeShape` Rectangle (PointD 1 (-1)) (PointD 3 1)
    , slideShape sq2 p5 `shouldBeShape`
      Rectangle (PointD (-1) (-1)) (PointD 3 3)
    , slideShape sq3 p5 `shouldBeShape`
      Rectangle (PointD (-1) (-3)) (PointD 3 1)
    ]
