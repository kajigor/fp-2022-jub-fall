...
unit_namesakes = do
  ...
  assertBool "namesakes" (namesakes child3 child4)
...
unit_valid = do
  ...
  assertBool "not valid: child with wrong birthId" (not $ validateNewPerson notValid5)
  assertBool "not valid: child with wrong birthId" (not $ validateNewPerson notValid6)
