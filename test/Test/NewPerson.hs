...
person1 =
  Person { firstName = "Kate"
         ...
         , formerLastNames = []
         , age = 29
         , documentNumber = Passport (1234, 567890) }
...
person2 =
  Person { firstName = "Kate"
         ...
         , formerLastNames = []
         , age = 42
         , documentNumber = Passport (9876, 543210) }
...
person3 =
  Person { firstName = "Kate"
         ...
         , formerLastNames = []
         , age = 21
         , documentNumber = Passport (2121, 212121) }
...
person4 =
  Person { firstName = "Maria"
         ...
         , formerLastNames = []
         , age = 23
         , documentNumber = Passport (1111, 111111) }
...
child1 =
  Person { firstName = "Ivan"
         ...
         , formerLastNames = []
         , age = 7
         , documentNumber = BirthCertificate ("IX", 000000) }
...
almostAdult =
  Person { firstName = "Masha"
         ...
         , formerLastNames = []
         , age = 13
         , documentNumber = BirthCertificate ("XX", 424242) }

wierdAdult :: Person
wierdAdult =
  Person { firstName = "ahsaM"
         , lastName = "avonavI"
         , formerLastNames = []
         , age = 31
         , documentNumber = BirthCertificate ("XX", 424242) }
...
unit_validNew = do
  assertBool "valid" (validatePerson almostAdult)
  assertBool "valid" (validatePerson $ ageUp almostAdult)
  assertBool "valid" (validatePerson $ ageUp $ ageUp almostAdult)

  assertBool "not valid: adult with BirthCertificate" (not $ validatePerson wierdAdult)
