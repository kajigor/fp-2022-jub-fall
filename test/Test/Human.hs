...
human1 =
  Human { firstName = "Kate"
         ...
         , formerLastNames = []
         , age = 29
         , documentID = Passport (1234, 567890) }
...
human2 =
  Human { firstName = "Kate"
         ...
         , formerLastNames = []
         , age = 42
         , documentID = Passport (9876, 543210) }
...
human3 =
  Human { firstName = "Kate"
         ...
         , formerLastNames = []
         , age = 21
         , documentID = Passport (2121, 212121) }
...
human4 =
  Human { firstName = "Maria"
         ...
         , formerLastNames = []
         , age = 23
         , documentID = Passport (1111, 111111) }
...
child1 =
  Human { firstName = "Ivan"
         ...
         , formerLastNames = []
         , age = 7
         , documentID = BirthCertificate 0123456789 }
...
child2 =
  Human { firstName = "Masha"
         ...
         , formerLastNames = []
         , age = 3
         , documentID = BirthCertificate 9876543210 }
